            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="lg:col-span-1 bg-indigo-900 rounded-3xl p-8 shadow-xl text-white overflow-hidden relative flex flex-col justify-center">
                    <div class="relative z-10">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.analytics.chat') }}" class="flex items-center gap-3 px-6 py-4 bg-white border border-slate-100 rounded-2xl hover:bg-slate-50 transition shadow-sm group mb-3">
                                ...
                                <span class="text-sm font-bold text-slate-700">Chat Analytics</span>
                            </a>
                            <a href="{{ route('admin.logs.index') }}" class="flex items-center gap-3 px-6 py-4 bg-white border border-slate-100 rounded-2xl hover:bg-slate-50 transition shadow-sm group">
                                ...
                                <span class="text-sm font-bold text-slate-700">Lihat Deployment Logs</span>
                            </a>
                        </div>
                    </div>
